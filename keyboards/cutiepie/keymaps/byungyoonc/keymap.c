...
[_QWERTY] = LAYOUT(
    ...
    NUM,     KC_LALT, TL_LOWR, KC_LSFT,          KC_SPC,           TL_UPPR, KC_RALT, CADET
),
/* Extend
 * ,-----------------------------------------------------------------------.
...
[_EXTEND] = LAYOUT(
    ...
    C(KC_Z), C(KC_X), C(KC_C), C(KC_V), KC_APP,  KC_ENT,  XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,
...
[_SYMBOL] = LAYOUT(
    ...
    KC_AMPR, KC_ASTR, KC_CIRC, KC_DLR,  KC_APP,  KC_UNDS, KC_LCBR, KC_RCBR, KC_PIPE, KC_DQT,
    _______, _______, _______, _______,          _______,          _______, _______, _______
),
/* Function
 * ,------------------------------------------------------------------------.
...
[_NUMBER] = LAYOUT(
    ...
    C(KC_Z), C(KC_X), C(KC_C), C(KC_V), KC_APP,  KC_ENT,  KC_1,    KC_2,    KC_3,    KC_PDOT,
